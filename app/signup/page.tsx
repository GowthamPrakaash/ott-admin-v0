...
export default async function SignUpPage() {
  // No invite token logic needed
  // Allow signup if no users exist, else allow anyone to sign up as viewer/editor/admin based on email
  // (Role assignment will be handled in the backend)
  return (
